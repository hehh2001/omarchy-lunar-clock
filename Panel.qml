...
Panel {
  ...
  readonly property var todayLunar: Lunar.date(today.getFullYear(), today.getMonth(), today.getDate())
  ...
  readonly property var labelLocale: Qt.locale("zh_CN")
      ...
      Flickable {
        ...
        Column {
          ...
          Item {
            ...
            Row {
              ...
              Text {
                ...
                text: Qt.formatDate(root.today, "M月d日")
                color: heroMouse.containsMouse
                  ? Style.hoverStateColor(root.contentForeground, Color.accent)
                  : root.contentForeground
                font.family: root.contentFontFamily
          ...
          Text {
            ...
            text: root.todayLunar ? root.todayLunar.full : "农历支持 1900–2100 年"
              ...
              Row {
                ...
                Rectangle {
                  ...
                  PanelToolTip {
                    ...
                    text: "每周从" + root.nextWeekStartLabel + "开始"
                    fontFamily: root.contentFontFamily
                  }
                }
                ...
                Row {
                  ...
                  Repeater {
                    ...
                    Rectangle {
                      ...
                      readonly property var lunar: Lunar.date(modelData.year, modelData.month, modelData.day)
                      Column {
                        anchors.centerIn: parent
                        spacing: Style.space(3)
                        Text {
                          anchors.horizontalCenter: parent.horizontalCenter
                          text: modelData.day
                          color: modelData.inMonth ? root.contentForeground : Qt.alpha(root.contentForeground, 0.3)
                          font.family: root.contentFontFamily
                          font.pixelSize: Style.font.body
                        ...
                        Text {
                          anchors.horizontalCenter: parent.horizontalCenter
                          text: lunar ? lunar.label : "—"
                          color: !modelData.inMonth ? Qt.alpha(root.contentForeground, 0.25)
                            : lunar && (lunar.festival || lunar.day === 1)
                              ? Style.selectedStateColor(root.contentForeground, Color.accent)
                              : Qt.alpha(root.contentForeground, 0.6)
                          font.family: root.contentFontFamily
                          font.pixelSize: Style.font.caption
                        }
                      }
                      ...
                      PanelToolTip {
                        ...
                        text: modelData.key + "\n" + (lunar ? lunar.full : "农历支持 1900–2100 年")
                        fontFamily: root.contentFontFamily
                      }
                    }
                  }
          ...
          Item {
            ...
            Item {
              ...
              Text {
                ...
                horizontalAlignment: Text.AlignHCenter
                text: Qt.formatDate(root.viewDate, "yyyy年 M月")
